...
public class NPCDialogueSystem : MonoBehaviour
{
    ...
    /// </summary>
    public TextMeshPro dialogueTextObject;
    ...
    /// <summary>
    /// This will help to automatically skip the text after a certain period of time.
    /// </summary>
    public float automaticNextTime;

    public float automaticNextTextTime;
    ...
    private void Awake()
    {
        ...
        automaticNextTextTime = automaticNextTime;
    }
    #endregion
    ...
    private void Update()
    {
        if (Input.GetKeyDown(skipKey) || automaticNextTextTime < 0)
        {
